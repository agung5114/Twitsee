    ...
    if tombol:
        ...
        for i in pemdas:
            ...
            with c1:
                ...
                # link1 = f"https://www.lightpollutionmap.info/#zoom=10&lat=-6.1750&lon=106.8275&state=eyJiYXNlbWFwIjoiTGF5ZXJCaW5nUm9hZCIsIm92ZXJsYXkiOiJ2aWlyc18yMDE4Iiwib3ZlcmxheWNvbG9yIjp0cnVlLCJvdmVybGF5b3BhY2l0eSI6NjAsImZlYXR1cmVzb3BhY2l0eSI6ODV9"
            ...
            with c2:
                ...
                link2 = f"https://www.lightpollutionmap.info/#zoom=10.00&lat={lat}&lon={lon}&state=eyJiYXNlbWFwIjoiTGF5ZXJCaW5nUm9hZCIsIm92ZXJsYXkiOiJ2aWlyc18yMDIyIiwib3ZlcmxheWNvbG9yIjp0cnVlLCJvdmVybGF5b3BhY2l0eSI6NjAsImZlYXR1cmVzb3BhY2l0eSI6ODV9"
                ...
                if link2 is not None:
                        ...
                        name2 = f'2022-{i}.png'
                        # hti2.screenshot(html_str=html2,size=(880,720),save_as=name2)
